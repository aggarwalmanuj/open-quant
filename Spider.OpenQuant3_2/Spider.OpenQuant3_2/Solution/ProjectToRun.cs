...
namespace Spider.OpenQuant3_2.Solution
{
    public class ProjectToRun
    {
        ...
        public ProjectToRun WithProjectIndex(int index)
        {
            ...
            if (ProjectTemplate == ProjectTemplateType.Close)
                OQProjectName = Enum.Parse(typeof (CloseOrderProjectNames), "Close32_" + index.ToString("00")).ToString();
            else if (ProjectTemplate == ProjectTemplateType.OpenLong)
                OQProjectName = Enum.Parse(typeof (OpenOrderProjectNames), "Open32_" + index.ToString("00")).ToString();
            else if (ProjectTemplate == ProjectTemplateType.OpenShort)
                OQProjectName = Enum.Parse(typeof (OpenOrderProjectNames), "Open32_" + index.ToString("00")).ToString();
            else if (ProjectTemplate == ProjectTemplateType.ReverseOpen)
                OQProjectName = Enum.Parse(typeof(ReverseOpenOrderProjectNames), "ReverseOpen32_" + index.ToString("00")).ToString();
            else if (ProjectTemplate == ProjectTemplateType.ReverseClose)
                OQProjectName = Enum.Parse(typeof(ReverseCloseOrderProjectNames), "ReverseClose32_" + index.ToString("00")).ToString();
            else if (ProjectTemplate == ProjectTemplateType.QuoteServer)
                OQProjectName = "QuoteServer";
