...
namespace Spider.OpenQuant4.Base
{
    ...
    public abstract class BaseQuantityFocusedStrategy : BaseStrategy
    {
        ...
        [Parameter("Specific Position Size", "Position Sizing Management")]
        public int? SpecificPositionSize;

        [Parameter("Specific Position Side To Reverse", "Position Sizing Management")]
        public PositionSide? SpecificPositionSideToReverse;
